...
@Component({
  selector: 'app-them-moi-nhap-hang',
  templateUrl: './them-moi-nhap-hang.component.html',
  styleUrls: ['./them-moi-nhap-hang.component.scss']
})
export class ThemMoiNhapHangComponent implements OnInit {
